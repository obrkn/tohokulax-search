...
file_path = File.join(Dir.pwd, 'public', 'ameblo_passer-hiro53', 'list.json')
...
years.each do |year|
  ...
  File.write(File.join(Dir.pwd, 'public', 'ameblo_passer-hiro53', "#{year}.json"), JSON.pretty_generate(outputs))
end
