...
file_path = File.join(Dir.pwd, 'public', 'ameblo_jolax-tohoku', 'list.json')
...
years.each do |year|
  ...
  File.write(File.join(Dir.pwd, 'public', 'ameblo_jolax-tohoku', "#{year}.json"), JSON.pretty_generate(outputs))
end
