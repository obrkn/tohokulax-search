...
file_path = File.join(Dir.pwd, 'public', 'ameblo_tohokulaxmgs', 'list.json')
...
years.each do |year|
  ...
  File.write(File.join(Dir.pwd, 'public', 'ameblo_tohokulaxmgs', "#{year}.json"), JSON.pretty_generate(outputs))
end
